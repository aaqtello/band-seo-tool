...
$(".link-main.no-bold").remove();

window.setInterval(function(){
    $(".nav-menu-user-avatar").html("<a href='https://brandseotools.com' style='color: #fff; margin-top: 8px; font-size: 20px;' target='_blank'>Band seo tools</a>");
